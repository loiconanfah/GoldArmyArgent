...
.body-layout{display:flex;background:linear-gradient(to right, #111827 240px, #1F2937 240px);}
.sidebar{width:240px;flex-shrink:0;background:transparent;padding:28px 22px;}
