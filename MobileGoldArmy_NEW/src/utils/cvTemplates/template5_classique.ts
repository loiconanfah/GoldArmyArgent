...
.exp-loc{color:#888;}
.bullet-row{display:flex;align-items:flex-start;gap:8px;margin-bottom:3px;}
...
.lang-item{font-size:10px;color:#333;margin-bottom:4px;}
.cert-item{font-size:10px;color:#444;margin-bottom:4px;font-style:italic;}
</style></head><body>
<div class="page">
