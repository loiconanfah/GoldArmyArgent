...
.lang-item{font-size:10px;color:#333;margin-bottom:4px;padding-left:10px;border-left:2px solid ${ACCENT};}
.cert-item{font-size:10px;color:#444;margin-bottom:4px;padding-left:10px;border-left:2px solid #ddd;}
</style></head><body>
<div class="page">
  <div class="name-row">
