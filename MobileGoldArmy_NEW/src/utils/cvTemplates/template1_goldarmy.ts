...
.ci{font-size:11px;}
.body-layout{display:flex;background:linear-gradient(to right, #F3EEE6 230px, #FAFAF8 230px);}
.sidebar{width:230px;flex-shrink:0;background:transparent;padding:26px 20px;}
