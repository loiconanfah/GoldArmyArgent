...
# Update features with colors and icons
content = content.replace("color: 'from-indigo-500 to-purple-500'", "color: 'bg-indigo-50', textColor: 'text-indigo-600'")
content = content.replace("color: 'from-blue-500 to-violet-500'", "color: 'bg-emerald-50', textColor: 'text-emerald-600'")

# Add logo component to template later
        ...
        <div class="header-title-box">
          <div class="flex items-center gap-4 mb-2">
            <div class="w-12 h-12 bg-white rounded-2xl shadow-sm border border-slate-100 flex items-center justify-center overflow-hidden">
               <img src="/logo_ga.png" class="w-8 h-8 object-contain animate-pulse" />
            </div>
...
# Replace template and add style
