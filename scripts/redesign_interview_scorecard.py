...
# Replace the old scorecard modal
# Block starts around line 1053
scorecard_pattern = r'<!-- SCORECARD MODAL -->\s*<div v-if="showScorecard".*?</div>\s*</div>\s*</div>'
content = re.sub(scorecard_pattern, scorecard_modal, content, flags=re.DOTALL)
