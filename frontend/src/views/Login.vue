    ...
    <div class="auth-card">
      ...
      <div class="auth-card__visual">
        ...
        <div class="auth-card__visual-footer">
          <h2 class="auth-card__slogan" v-html="t('auth.slogan')"></h2>
      ...
      <div class="auth-card__form-wrap">
        <div class="auth-card__form">
          <header class="auth-form__header">
            <h1 class="auth-form__title">{{ t('auth.login_title') }}</h1>
            <p class="auth-form__subtitle">
              {{ t('auth.no_account') }}
              <router-link to="/register" class="auth-form__link">{{ t('auth.register_link') }}</router-link>
            </p>
          </header>
          ...
          <form @submit.prevent="handleLogin" class="auth-form">
            <div class="auth-form__field">
              <label class="auth-form__label">{{ t('auth.email_label') }}</label>
            ...
            <div class="auth-form__field">
              <label class="auth-form__label">{{ t('auth.password_label') }}</label>
              <div class="auth-form__input-wrap">
            ...
            <div class="auth-form__row">
              <label class="auth-form__checkbox-wrap">
                <input type="checkbox" class="auth-form__checkbox" />
                <span class="auth-form__checkbox-label">{{ t('auth.remember_me') }}</span>
              </label>
              <a href="#" class="auth-form__forgot">{{ t('auth.forgot_password') }}</a>
            </div>
            ...
            <div class="auth-form__divider">
              <span class="auth-form__divider-text">{{ t('auth.or_connect_with') }}</span>
            </div>

            <div class="auth-form__social">
              <div id="google-btn-login" class="auth-form__google"></div>
...
.auth-form__row {
  ...
  flex-wrap: wrap;
  gap: 0.5rem;
  animation: auth-fade-in 0.5s 0.35s ease-out both;
}
...
.auth-form__submit {
  ...
  animation: auth-fade-in 0.5s 0.4s ease-out both;
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 0.5rem;
