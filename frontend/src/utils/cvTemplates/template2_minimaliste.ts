...
.pill{background:#EFF6FF;border:1px solid #BFDBFE;border-radius:4px;padding:2px 8px;font-size:10px;color:#1D4ED8;font-weight:500;margin:2px 2px;display:inline-block;}
